...
import be.bosa.commons.eid.client.tests.integration.simulation.SimulatedCardTerminal;
import be.bosa.commons.eid.client.tests.integration.simulation.SimulatedCardTerminals;
